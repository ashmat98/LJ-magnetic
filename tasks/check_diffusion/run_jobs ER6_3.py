...
params_simulation = {
    ...
    "algorithm" : "VERLET",
    "before_step" : "tasks.check_diffusion.run_jobs ER6_3.before_step"
}
...
if __name__ == "__main__":
    for k in range(n+1):
        ...
        submit_with_estimates_and_params(params_model, params_init, params_simulation,copies=200, 
